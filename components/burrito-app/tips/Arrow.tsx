...
const Arrow = forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof RadixTooltip.Arrow> & { side?: string }
>(({ width = 20, height = 20, side = 'top', ...props }, ref) => {
  let stokeColor;

  switch (side) {
    case 'right':
      stokeColor = 'stroke-[#bef264]';
      break;
    case 'left':
      stokeColor = 'stroke-[#0ea5e9]';
      break;
    default:
      stokeColor = 'stroke-[#68c09e]';
      break;
  }
  ...
  return (
    ...
    >
      ...
      <g mask="url(#mask0_5_6)">
        <path className="fill-black" d="M20 0H0l10 20L20 0z"></path>
        <path
          className={stokeColor}
